...
local eyesMeet1 = {74414610892616, 12975931368}
local eyesMeet2 = {91297650391984, 12975943643}
local eyesMeet3 = {101359632046438, 12975953850}
...
return {
	...
	Battles = {
		...
		{ -- [#220] : Elite 4 Wulfric
			...
			TrainerDifficulty = 6,
			Payout = 210 * 32,
			LosePhrase = {'This is cold...'},
			Party = {
				{ name = 'Vanilluxe', level = 85,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'blizzard' },{ id = 'freezedry' },
					{ id = 'iceshard' },{ id = 'taunt' },
				}},
				{ name = 'Lapras', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'freezedry' },{ id = 'icebeam' },
					{ id = 'hydropump' }, { id = 'perishsong' },
				}},
				{ name = 'Mamoswine', level = 85,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'iceshard' },{ id = 'earthquake' },
					{ id = 'iciclecrash' },{ id = 'knockoff' },
				}},
				{ name = 'Beartic', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'playrough' },{ id = 'superpower' },
					{ id = 'swordsdance' }, { id = 'iciclecrash' },
				}},
				{ name = 'Mr. Rime', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'rapidspin' }, { id = 'slackoff' },
					{ id = 'futuresight' },{ id = 'freezedry' },
				}},
				{ name = 'Abomasnow ', level = 85, item = 'abomasite', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'blizzard' },{ id = 'woodhammer' },
					{ id = 'earthquake' }, { id = 'iceshard' },
				}},
		...
		{ -- [#221] : Elite 4 Bruno
			...
			TrainerDifficulty = 6,
			Payout = 200 * 100,
			LosePhrase = {'I really pummelled this...'},
			Party = {
				{ name = 'Machamp', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'bulletpunch' },{ id = 'closecombat' },
					{ id = 'bulkup' },{ id = 'facade' },
				}},
				{ name = 'Falinks', level = 85,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'firstimpression' },{ id = 'rockslide' },
					{ id = 'throatchop' }, { id = 'closecombat' },
				}},
				{ name = 'Grapploct', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'octolock' },{ id = 'drainpunch' },
					{ id = 'icepunch' },{ id = 'closecombat' },
				}},
				{ name = 'Bewear', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'swordsdance' },{ id = 'doubleedge' },
					{ id = 'closecombat' }, { id = 'darkestlariat' },
				}},
				{ name = 'Lucario', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'meteormash' },{ id = 'extremespeed' },
					{ id = 'closecombat' }, { id = 'swordsdance' },
				}},
				{ name = 'Gallade', level = 85, item = 'galladite', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'zenheadbutt' }, { id = 'knockoff' },
					{ id = 'nightslash' },{ id = 'earthquake' },
				}},
			},
		...
		{ -- [#222] : Elite 4 Diantha
			...
			TrainerDifficulty = 6,
			Payout = 250 * 100,
			LosePhrase = {'Maybe black magic is better...'},
			Party = {
				{ name = 'Sylveon', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'moonblast' },{ id = 'toxic' },
					{ id = 'healbell' },{ id = 'wish' },
				}},
				{ name = 'Mawile', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'suckerpunch' },{ id = 'playrough' },
					{ id = 'swordsdance' }, { id = 'firefang' },
				}},
				{ name = 'Aromatisse', level = 85,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'trickroom' },{ id = 'nastyplot' },
					{ id = 'moonblast' },{ id = 'psychic' },
				}},
				{ name = 'Slurpuff', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'bellydrum' },{ id = 'playrough' },
					{ id = 'return' }, { id = 'drainpunch' },
				}},
				{ name = 'Cresselia', level = 85,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'moonblast' },{ id = 'psyshock' },
					{ id = 'toxic' }, { id = 'moonlight' },
				}},
				{ name = 'Gardevoir', level = 85, item = 'gardevoirite', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'thunderbolt' }, { id = 'psychic' },
					{ id = 'moonblast' },{ id = 'shadowball' },
				}},
			},
		...
		{ -- [#223] : Elite 4 Lance
			...
			TrainerDifficulty = 5,
			Payout = 300 * 100,
			LosePhrase = {'I wish I caught rayquaza...'},
			Party = {
				{ name = 'Dracovish', level = 85,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'fishiousrend' },{ id = 'psychicfangs' },
					{ id = 'crunch' },{ id = 'dragonrush' },
				}},
				{ name = 'Noivern', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'hurricane' },{ id = 'taunt' },
					{ id = 'dragonpulse' }, { id = 'roost' },
				}},
				{ name = 'Dragonite', level = 85, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'dragondance' },{ id = 'earthquake' },
					{ id = 'extremespeed' },{ id = 'dragonrush' },
				}},
				{ name = 'Haxorus', level = 85, shiny = true, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'swordsdance' },{ id = 'outrage' },
					{ id = 'earthquake' }, { id = 'poisonjab' },
				}},
				{ name = 'Turtonator', level = 85,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'shellsmash' },{ id = 'fireblast' },
					{ id = 'dragonpulse' }, { id = 'dracometeor' },
				}},
				{ name = 'Gyarados', level = 85, shiny = true, item = 'gyaradosite', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'dragondance' }, { id = 'waterfall' },
					{ id = 'icefang' },{ id = 'earthquake' },
				}},
			},
		...
		{ -- [#224] : Champion Brad
			...
			Party = {
				{ name = 'Magearna', level = 90,forme = 'Original', shiny = false, 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'fleurcannon' },{ id = 'steelbeam' },
					{ id = 'focusblast' },{ id = 'shiftgear' },
				}},
				{ name = 'Feraligatr', level = 90, shiny = true, item = 'lifeorb',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'dragondance' },{ id = 'icepunch' },
					{ id = 'crunch' }, { id = 'liquidation' },
				}},
				{ name = 'Lycanroc', level = 90,forme = 'midnight',item = 'choicescarf', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'accelerock' },{ id = 'darkestlariat' },
					{ id = 'closecombat' },{ id = 'stealthrock' },
				}},
				{ name = 'Aegislash', level = 90,item = 'weaknesspolicy',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'swordsdance' },{ id = 'kingsshield' },
					{ id = 'shadowsneak' }, { id = 'sacredsword' },
				}},
				{ name = 'Glalie', level = 90, item = 'glalitite',shiny = true,  
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'earthquake' }, { id = 'iceshard' },
					{ id = 'doubleedge' },{ id = 'firefang' },
				}},
				{ name = 'Kyurem', level = 90, forme = 'Blackoverdrive', 
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
					{ id = 'nastyplot' },{ id = 'fusionbolt' },
					{ id = 'earthpower' }, { id = 'icebeam' },
				}},

			},

		},
		{ -- [#225] : Route 15 - Adventurer Tanner
			Name = 'Jeremy',
			IntroPhrase = {'I\'ve been everywhere but I\'ve learned to appreciate the mountains the most.', 
				'There\'s a certain sort of beauty that these mountains offer you that you just', 'don\'t see anywhere else.'},
			LosePhrase = 'Well at least I still have the mountains.',
		...
		{ -- [#226] : Champion Brad
			...
			Payout = 30 * 100,
			LosePhrase = {'Darnit.. I guess you can go in there now..'},
			Party = {
				{ name = 'Gardevoir', level = 50, shiny = true, item = 'choicescarf', ability = 'Trace', nature = 'Timid',
					ivs = {31, 0, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'moonblast' },{ id = 'psychic' },
						{ id = 'trick' }, { id = 'destinybond' },
					}},
				{ name = 'Crawdaunt', level = 90,forme = 'choiceband',item = 'choicescarf', ability = 'Adaptability', nature = 'Adamant',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'aquajet' },{ id = 'crabhammer' },
						{ id = 'knockoff' },{ id = 'superpower' },
					}},
				{ name = 'Blissey', level = 90,item = 'leftovers', ability = 'naturalcure', nature = 'Bold',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 0, 252, 0, 0, 4},
					moves = {
						{ id = 'wish' },{ id = 'protect' },
						{ id = 'seismictoss' }, { id = 'thunderwave' },
					}},
				{ name = 'Skarmory', level = 90, item = 'rockyhelmet',shiny = true,  ability = 'Sturdy', nature = 'Impish' ,
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {252, 0, 252, 0, 0, 0},
					moves = {
						{ id = 'whirlwind' }, { id = 'stealthrock' },
						{ id = 'roost' },{ id = 'defog' },
					}},
				{ name = 'Sceptile', level = 50, item = 'sceptilite', shiny = false, nature = 'Naive',
					ivs = {31, 31, 31, 31, 31, 31},
					evs = {6, 0, 0, 252, 0, 252},
					moves = {
						{ id = 'dragonpulse' },{ id = 'gigadrain' },
						{ id = 'earthquake' },{ id = 'hiddenpower' },
					}},
				{ name = 'Raikou', level = 90, forme = 'lifeorb',  ability = 'Pressure',
					ivs = {31, 0, 30, 31, 31, 31},
					evs = {0, 0, 0, 252, 4, 252},
					moves = {
						{ id = 'thunderbolt' },{ id = 'voltswitch' },
						{ id = 'hiddenpower' }, { id = 'extrasensory' },
					}},
			},

		},
		{ -- [#227] : Roria League - Tess
			Name = 'Rival Tess',
			TrainerDifficulty = 5,
			Payout = 300 * 66,
			LosePhrase = {'You\'re always this strong!'},
			Party = {
				-- [[
				{ name = 'Garchomp', level = 80, 
					gender = 'F',
					ability = 'Sand Veil', 
					moves = {
						{ id = 'dragonclaw' }, { id = 'slash' },
				...
				{ name = 'Goodra', level = 80,
					gender = 'M',
					ability = 'Hydration', 
					moves = {
						{ id = 'fireblast' }, { id = 'earthquake' },
						{ id = 'thunderbolt' }, { id = 'dracometeor' },
					}
				},
				{ name = 'Druddigon', level = 80,
					gender = 'M',
					ability = 'Rough Skin', 
					moves = {
						{ id = 'outrage' }, { id = 'rockclimb' },
