--// Project: Supernova Sun + Project: Crescent Moon - National Dex Movesets
--// Featuring: Generation 9 + Hisuian Moves
...
setup: Used for setup moves in-game, checked in BattleSide. -- Project: Supernova Sun | Trainer AI Fixes
...
return {
	...
	--------------------------------------------------------------------------------------------------
	--[[MISSING/ADDED Generation 9 Moves listed below!]]--
	['alluringvoice'] = {
		num = 922,
		accuracy = 100,
		basePower = 80,
	...
	['dragoncheer'] = {
		...
		effect = {
			...
			onStart = function(target, source)
				...
				self:add('-singleturn', target, 'Dragon Cheer', '[of] ' .. source)
			end,
			...
			onBasePower = function(basePower)
				self:debug('Boosting from Dragon Cheer = ' .. self.effectData.multiplier)
	...
	['mightycleave'] = {
		...
		pp = 5,
		ignoreAbility = true,
		flags = {sharpness = true, protect = true, mirror = true},
		target = "normal",
		type = "Rock"
	},
	['psychicnoise'] = {
	...
	['terastarstorm'] = { -- moment when no terrasteralize or whatever its called, lol
		num = 933,
		accuracy =  100,
		basePower =  100,
		category =  "Special",
	...
	--[[Generation 9 Moves + Hisui listed below!]]--
	...
	['populationbomb'] = {
		num = 938,  -- was formerly 879, messing up with salt cure.
		accuracy =  90,
		basePower =  20,
		category = "Physical",
		id = "populationbomb",
	...
	['ragingbull'] = {
		num = 936, -- was formerly 882, messing up with snowscape.
		accuracy = 100,
		basePower = 90,
		category = 'Physical',
		name = 'Raging Bull',
	...
	['bleakwindstorm'] = { -- Should be fixed now. / NeoScripts
		num = 894,
		accuracy = 100,
		basePower = 95,
		category = "Special",
	...
	['ceaselessedge'] = { -- Project: Supernova Sun | Ceaseless Edge Fix
		num = 895,
		accuracy = 90,
		basePower = 65,
		category = 'Physical',
